...
DATA_PATH=/opt/aps/workdir/sht-RAG_RL/datasets/stage_rl/stage1.jsonl
# /home/songhuatong/OpenRLHF/data/demo_dataset
#
# Path of backbone model(DeepSeek-R1-Distill-Qwen-1.5B)
TOKENIZER_PATH=/opt/aps/workdir/model/Meta-Llama-3.1-8B-Instruct
...
SAVE_MODEL_NAME=llama-inst-stage1
