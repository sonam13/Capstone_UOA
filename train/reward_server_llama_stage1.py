...
class MathRuleProxy:
    ...
    def get_reward(self, queries):
        ...
        for i, query in enumerate(queries):
            ...
            if count_1 == count_2 == count_3 == count_4 == count_5 == count_6 == count_7>=1:
                pass
            else:
                format_punishment=True


            if format_punishment==False:
            ...
            if count_think_1 ==0 and count_think_2==count_answer_1==count_answer_2==1:
                scores[i] = scores[i]+0.5
            else:
                pass
